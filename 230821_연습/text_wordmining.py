...
font_path = r"C:\Users\it\Downloads\평창평화체_B\평창평화체B\PyeongChangPeace-Bold.ttf"
...
# 워드 클라우드 생성을 위해 딕셔너리를 사용하도록 수정
wordcloud = WordCloud(background_color='white', font_path=font_path,
                      width=800, height=400).generate_from_frequencies(word_count)
