...
csvFileList = ["C:/CookAnalysis/CSV/testA.csv",
               "C:/CookAnalysis/CSV/testB.csv",
               "C:/CookAnalysis/CSV/testC.csv"]
...
outWorkbook.save('c:/CookAnalysis/Excel/testCSV_230822.xls')
print("Save. OK~")
