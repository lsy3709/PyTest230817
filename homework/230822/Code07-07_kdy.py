...
csvFileList = ["C:/CookAnalysis/CSV/test1.csv",
               "C:/CookAnalysis/CSV/test2.csv",
               "C:/CookAnalysis/CSV/test3.csv"]
...
outWorkbook.save('c:/CookAnalysis/Excel/test_kdy_230822.xls')
print("Save. OK~")