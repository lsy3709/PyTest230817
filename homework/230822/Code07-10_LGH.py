# 2개의 csv를 합쳐서, 엑셀 파일에 출력하기
# 최종 n개의 csv를 합쳐서, 한방에 엑셀 파일에 출력하기
import xlwt
import csv
import os

# csv 재료 합치려는 csv파일명 목록
csvFileList = ["C:/CookAnalysis/CSV/test12.csv", "C:/CookAnalysis/CSV/test23.csv", "C:/CookAnalysis/CSV/test34.csv"]
# xlwt 엑셀 파일 만드는 인스턴스
...
outWorkbook.save('c:/CookAnalysis/Excel/totaltest_230822.xls')
print("Save. OK~")