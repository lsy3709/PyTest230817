...
csvFileList = ["C:/CookAnalysis/CSV/user1.csv",
               "C:/CookAnalysis/CSV/user2.csv", "C:/CookAnalysis/CSV/user3.csv"]
...
outWorkbook.save('c:/CookAnalysis/Excel/userCSV_KHS.xls')
print("Save. OK~")
